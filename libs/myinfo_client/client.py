...
class MyInfoClient(object):
    ...
    @retry(stop_max_attempt_number=settings.MAX_RETRIES, wait_exponential_multiplier=settings.RETRIES_EXPO_MULTIPLIER)
    def get_access_token(self, auth_code: str, callback_url: str = None):
        ...
        if not callback_url:
            callback_url = settings.MYINFO_APP_REDIRECT_URL
    ...
    @staticmethod
    def get_authorise_url(state, callback_url: str = None) -> str:
        """
