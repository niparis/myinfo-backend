...
# sandbox root
MYINFO_API_BASE="https://sandbox.api.myinfo.gov.sg/com/v3/"
MYINFO_API_AUTHORISE = MYINFO_API_BASE + 'authorise'
MYINFO_API_TOKEN = MYINFO_API_BASE + 'token'
MYINFO_API_PERSON = MYINFO_API_BASE + 'person'
AUTH_LEVEL="L0"
